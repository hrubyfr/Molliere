void rootmacro(){
    ...
    for (int i = 0; i < 10; i++){
        ...
        Canvas -> cd(1);
        CyllinderAbs_hists[i] = (TH1D*) readfiles [i] -> Get("Ecyl");
        ...
        Canvas -> cd(2);
        BoxAbs_hists[i] = (TH1D*) readfiles [i] -> Get("Eoutbox");
    ...
    Molliere_graph -> SetTitle ("Zavislost pomeru energie absorbovane ve valci a celkove absorbovane energie na polomeru valce v PbWO_{4}");
    ...
    auto line3 = new TLine(19.59, 0., 19.59, 1.02);
