void rootmacro(){
    ...
    Molliere_graph -> SetTitle ("Zavislost pomeru energie absorbovane ve valci a celkove absorbovane energie na polomeru valce v BGO");
    ...
    auto line3 = new TLine(22.59, 0., 22.59, 1.02);
